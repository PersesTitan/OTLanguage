...
public class MakeMapVariable implements VariableWork, Repository {
    ...
    public MakeMapVariable(String patternText, VariableType variableType) {
    ...
    public void start(String line,
        ...
        if (matcher.find()) {
            ...
            //저장소에 값 저장
            repository.get(variableType).put(name, new LinkedHashMap<>());
            set.add(name);
        }
    }
}
