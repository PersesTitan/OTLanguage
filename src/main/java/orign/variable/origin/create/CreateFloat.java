...
import static check.VariableCheck.isFloat;

public class CreateFloat implements StartWork, VariableToken, Controller {
    private final Pattern pattern;
    private final String type;

    public CreateFloat(String type, Map<String, Map<String, Object>> repository) {
