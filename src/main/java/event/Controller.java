...
import make.custom.variable.controller.AddCustomClass;
...
public interface Controller extends ListSetting {
    ...
    ConsoleScanner consoleScanner = new ConsoleScanner(); //출력, 입력
    ...
    // 커스텀 클래스
    AddCustomClass addCustomClassWork = new AddCustomClass("ㅋㅅㅋ");
