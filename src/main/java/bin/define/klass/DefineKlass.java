...
import static bin.define.item.MethodItemTool.*;
import static bin.token.LoopToken.METHOD;
import static bin.token.Token.BL;
import static bin.token.Token.BR;

public class DefineKlass extends StartWorkV3 implements MergeToken {
    // 1
    public DefineKlass(int... counts) {
        super(counts);
    }
    ...
    public void start(String line, String[] params,
        ...
        if (parameter.startsWith("[") && parameter.endsWith("]")
            ...
            getParameters(klassName, parameter, loop);
    ...
    private void resetKlassMethod(String klassName) {
