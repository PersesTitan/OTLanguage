...
public class AllBoolCalculator implements BoolToken, NumberToken, MergeToken, Token {
    public String start(String line) {
        return orAnd(Controller.allCompareCalculator.start(line));
    }
    ...
    public String orAnd(String line) {
        ...
        return matcherOrAnd.reset((line = not(blank(line)))).find() ? orAnd(line) : line;
    }
