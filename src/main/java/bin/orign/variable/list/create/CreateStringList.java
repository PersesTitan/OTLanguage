...
public class CreateStringList implements StartWork, VariableToken, GetList {
    private final String patternText;
    private final Pattern pattern;
    private final String type;

    public CreateStringList(String type, Map<String, Map<String, Object>> repository) {
    ...
    public void start(String line, String origen,
        ...
        if (matcher.find()) {
            ...
            if (value.isBlank()) list = new LinkedList<>();
                ...
                else if (value.startsWith(VARIABLE_PUT)) list = getStringList(value.substring(VARIABLE_PUT.length()));
