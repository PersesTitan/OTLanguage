...
public class CreateFloatMap implements
    ...
    public CreateFloatMap(String type, Map<String, Map<String, Object>> repository) {
    ...
    public void start(String line, String origen,
        ...
        if (matcher.find()) {
            ...
            if (value.isBlank()) map = new LinkedHashMap<>();
                ...
                else if (value.startsWith(VARIABLE_PUT)) map = getFlotMap(value.substring(VARIABLE_PUT.length()));
