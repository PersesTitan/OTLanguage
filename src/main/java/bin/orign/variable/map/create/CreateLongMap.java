...
public class CreateLongMap implements StartWork, VariableToken, GetMap {
    private final String patternText;
    private final Matcher matcher;
    private final String type;

    public CreateLongMap(String type) {
    ...
    public void start(String line, String origen,
        ...
        if (matcher.find()) {
            ...
            if (value.isBlank()) map = new LinkedHashMap<>();
                ...
                else if (value.startsWith(VARIABLE_PUT)) map = getLongMap(value.substring(VARIABLE_PUT.length()));
