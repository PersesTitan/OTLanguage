...
public class CreateCharacterMap implements StartWork, VariableToken, GetMap {
    ...
    public void start(String line, String origen,
        ...
        if (matcher.find()) {
            ...
            if (value.isBlank()) map = new LinkedHashMap<>();
                ...
                else if (value.startsWith(VARIABLE_PUT)) map = getCharacterMap(value.substring(VARIABLE_PUT.length()));
