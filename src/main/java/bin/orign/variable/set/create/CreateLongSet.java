...
public class CreateLongSet implements
        StartWork, VariableToken, GetSet {
    private final String patternText;
    private final Pattern pattern;
    private final String type;

    public CreateLongSet(String type, Map<String, Map<String, Object>> repository) {
    ...
    public void start(String line, String origen,
        ...
        if (matcher.find()) {
            ...
            if (value.isBlank()) set = new LinkedHashSet<>();
                ...
                else if (value.startsWith(VARIABLE_PUT)) set = getLongSet(value.substring(VARIABLE_PUT.length()));
