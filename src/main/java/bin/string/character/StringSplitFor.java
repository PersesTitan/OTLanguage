...
public class StringSplitFor extends StartWorkV3 implements MergeToken {
    // 3: StrVariable, cut, loop
    public StringSplitFor() {
        super(3);
    }
    ...
    public void start(String line, String[] params,
        ...
        try {
            for (String li : str.split(Pattern.quote(cut))) {
