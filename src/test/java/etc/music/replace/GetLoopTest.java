...
public class GetLoopTest extends ReturnWorkV3 implements MusicRepository {
    // 1
    public GetLoopTest(int... counts) {
        super(counts);
    }
    ...
    public String start(String line, String[] params,
        ...
        return String.valueOf(musicRepository.get(params[0]).getLoop());
    }
}
