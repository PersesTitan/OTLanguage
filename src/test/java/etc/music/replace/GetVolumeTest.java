...
public class GetVolumeTest extends ReturnWorkV3 implements MusicRepository {
    // 1
    public GetVolumeTest(int... counts) {
        super(counts);
    }
    ...
    public String start(String line, String[] params,
        ...
        return String.valueOf(musicRepository.get(params[0]).getVolume());
    }
}
