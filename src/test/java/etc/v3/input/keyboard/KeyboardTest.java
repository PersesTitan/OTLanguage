package etc.v3.input.keyboard;

import etc.v3.input.keyboard.exception.KeyboardException;
...
public class KeyboardTest {
    ...
    private final Map<String, Integer> keyboard = new HashMap<>() {{
        ...
        put("도", VK_A); put("B", VK_B); put("C", VK_C); put("D", VK_D); put("E", VK_E); put("F", VK_F); put("G", VK_G);
