...
// 범용 계산기
public class AllNumberCalculator implements Token, NumberToken, MergeToken {
    private final String PM = orMerge(PLUS_CALCULATOR, MINUS_CALCULATOR);
    private final String DM = orMerge(DIVIDE_CALCULATOR, MULTIPLY_CALCULATOR, REMAINDER_CALCULATOR);
