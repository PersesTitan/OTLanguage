...
public class NumberCalculator implements CalculatorTool {
            ...
            if (token.equals(TOKEN)) {
                ...
                if (a.equals(TOKEN)) list.add(TRUE);           // ㅇㅇ
                    ...
                    if (compare.containsKey(a) || number.containsKey(a)) {
                        ...
                        if (!b.equals(TOKEN)) throw new MatchException().grammarTypeError(token + a + b, GrammarTypeClass.TOKEN);
    ...
    public void start(Stack<String> stack, LinkedList<TypeMap> ra) {
        if (stack.size() == 1) {
